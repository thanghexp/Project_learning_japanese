...
<form class="form-horizontal" action="" method="POST" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <?php echo form_dropdown('id_nguphap', $dropdown, set_value('id_nguphap', $row['id_nguphap']), 'class="col-xs-10 col-sm-5"'); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Nội dung" value="<?php echo set_value('noidung', $row['noidung']); ?>" name="noidung" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Vị trí" value="<?php echo set_value('vitri', $row['vitri']); ?>" name="vitri" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
