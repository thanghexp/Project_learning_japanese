...
<form class="form-horizontal" action="" method="POST" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Kunyomi" value="<?php echo set_value('kunyomi'); ?>" name="kunyomi" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Onyomi" value="<?php echo set_value('onyomi'); ?>" name="onyomi" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Âm hán" value="<?php echo set_value('amhan'); ?>" name="amhan" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Cách viết" value="<?php echo set_value('cachviet'); ?>" name="cachviet" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
                <span class="middle"><?php echo form_error('cachviet'); ?></span>
            </span>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Từ kanji" value="<?php echo set_value('tu_kanji'); ?>" name="tu_kanji" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
