	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
		...
		<?php foreach($table as $key => $row) { ?>
			<tr>
				...
				<td><a href="<?php echo base_url('kanji_nangcao/vidu_kanji_nangcao/view?id='.  base64_encode($this->encrypt->encode($row['id']))); ?>"><?php echo $row['ten'] ?></a></td>
				<td><?php echo $row['kunyomi']; ?></td>
				<td><?php echo $row['onyomi']; ?></td>
				...
				<td>
					<div class="hidden-sm hidden-xs action-buttons">
						...
						<a class="green" href="<?php echo base_url('kanji_nangcao/kanji_nangcao/edit?id='.  base64_encode($this->encrypt->encode($row['id'])));  ?>">
							<i class="ace-icon fa fa-pencil bigger-130"></i>
						</a>

						<a class="red" href="<?php echo base_url('kanji_nangcao/kanji_nangcao/delete?id='.  base64_encode($this->encrypt->encode($row['id']))); ?>">
