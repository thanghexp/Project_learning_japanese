...
<form class="form-horizontal" action="" method="POST" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Tiếng nhật" value="<?php echo set_value('tieude_tiengnhat', $row['tieude_tiengnhat']); ?>" name="tieude_tiengnhat" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Phát âm" value="<?php echo set_value('tieude_phatam', $row['tieude_phatam']); ?>" name="tieude_phatam" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Nghĩa" value="<?php echo set_value('tieude_nghia', $row['tieude_nghia']); ?>" name="tieude_nghia" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
