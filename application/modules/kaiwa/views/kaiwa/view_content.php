	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
		...
		<?php foreach($table as $key => $row) { ?>
			<tr>
				...
				<td><?php echo $row['noidung_phatam']; ?></td>
				<td><?php echo $row['noidung_nghia'];?></td>
				...
				<td>
					<div class="hidden-sm hidden-xs action-buttons">
						...
						<a class="green" href="<?php echo base_url('kaiwa/edit_content?id='. base64_encode($this->encrypt->encode($row['id']))); ?>">
							<i class="ace-icon fa fa-pencil bigger-130"></i>
						</a>

						<a class="red" href="<?php echo base_url('kaiwa/delete_content?id='. base64_encode($this->encrypt->encode($row['id']))); ?>">
...
<div class="clearfix form-actions">
	<div class=" col-md-9">
		<a href="<?php echo base_url('kaiwa/kaiwa/add_content?id_bai='.base64_encode($this->encrypt->encode($id_bai))); ?>" class="btn btn-success" style="font-weight:bold;"> Thêm mới</a>
