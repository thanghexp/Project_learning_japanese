	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
		...
		<?php foreach($table as $key => $row) { ?>
			<tr>
				...
				<td><a href="<?php echo base_url('kaiwa/view_content?id_bai='.  base64_encode($this->encrypt->encode($row['id_bai']))); ?>"><?php echo $row['ten']; ?></a></td>
				<td><?php echo $row['tieude_tiengnhat']; ?></td>
				<td><?php echo $row['tieude_phatam']; ?></td>
				<td><?php echo $row['tieude_nghia'];?></td>
				<td>
					<div class="hidden-sm hidden-xs action-buttons">
						...
						<a class="green" href="<?php echo base_url('kaiwa/kaiwa/edit_title?id_kawa='. base64_encode($this->encrypt->encode($row['id']))); ?>">
							<i class="ace-icon fa fa-pencil bigger-130"></i>
						</a>

						<a class="red" href="<?php echo base_url('kaiwa/kaiwa/delete_title?id_kawa='. base64_encode($this->encrypt->encode($row['id']))); ?>">
