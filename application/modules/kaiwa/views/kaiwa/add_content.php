...
<form class="form-horizontal" action="" method="POST" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Phát âm" value="<?php echo set_value('noidung_phatam'); ?>" name="noidung_phatam" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Nghĩa" value="<?php echo set_value('noidung_nghia'); ?>" name="noidung_nghia" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Nghĩa" value="<?php echo set_value('nguoinoi_kanji'); ?>" name="nguoinoi_kanji" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Nghĩa" value="<?php echo set_value('nguoinoi_tuhan'); ?>" name="nguoinoi_tuhan" class="col-xs-10 col-sm-5">
            <span class="help-inline col-xs-12 col-sm-7">
