	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
		...
		<?php foreach($table as $key => $row) { ?>
			<tr>
				...
				<td><?php echo $row['tiengnhat']; ?></td>
				<td><?php echo $row['tuhan']; ?></td>
				<td><?php echo $row['nghia_han'];?></td>
				...
				<td>
					<div class="hidden-sm hidden-xs action-buttons">
						...
						<a class="green" href="<?php echo base_url('tumoi/edit?id='. base64_encode($this->encrypt->encode($row['id']))); ?>">
							<i class="ace-icon fa fa-pencil bigger-130"></i>
						</a>

						<a class="red" href="<?php echo base_url('tumoi/delete?id='. base64_encode($this->encrypt->encode($row['id']))); ?>">
