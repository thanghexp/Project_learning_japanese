	...
	<table id="dynamic-table" class="table table-striped table-bordered table-hover">
		...
		<?php foreach($table as $key => $row) { ?>
			<tr>
				...
				<td><a href="<?php echo base_url('tuvung/vidu_tuvung/view?id='.  base64_encode($this->encrypt->encode($row['id']))); ?>"><?php echo $row['ten'] ?></a></td>
				...
				<td>
					<div class="hidden-sm hidden-xs action-buttons">
						...
						<a class="green" href="<?php echo base_url('tuvung/tuvung/edit?id='.  base64_encode($this->encrypt->encode($row['id'])));  ?>">
							<i class="ace-icon fa fa-pencil bigger-130"></i>
						</a>

						<a class="red" href="<?php echo base_url('tuvung/tuvung/delete?id='.  base64_encode($this->encrypt->encode($row['id']))); ?>">
