...
<form class="form-horizontal" action="" method="POST" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" id="form-field-1" placeholder="Nội dung" value="<?php echo set_value('noidung_vidu', $row['noidung_vidu']); ?>" name="noidung_vidu" class="col-xs-10 col-sm-5">
